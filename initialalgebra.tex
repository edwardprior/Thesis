...
\begin{eq*} C_{\mathrm{gp}}(\mathbb{G}_n) \to C_{\mathrm{gp}}(\mathbb{G}_n)^{\mathrm{mn}} \end{eq*}
...
\end{eq*}
\begin{eq*}
\delta \big( \, \alpha_{\hat{X}}(g; \mathrm{id}_{x_1}, ..., \mathrm{id}_{x_m}) \, \big) \, := \, \alpha_{\hat{X}}(g; \mathrm{id}_{\delta(x_1)}, ..., \mathrm{id}_{\delta(x_m)})
\end{eq*}
...
\begin{eq*} \begin{tikzcd}
\mathbb{G}_{2n} \ar[r, "\sim"] & \mathbb{G}_n + \mathbb{G}_n \ar[r, "\hat{\psi} + \hat{\psi}"] & \hat{X} + \hat{X} \ar[r, "\mathrm{id}_{\hat{X}} + \delta"] & \hat{X} + \hat{X} \ar[r, "i + i"] & \hat{X}
\end{tikzcd} \end{eq*}
...
\begin{eq*} \mathrm{im}(u_{\mathrm{ob}})  \, = \, \langle \, \mathrm{im}(\hat{\psi}_{\mathrm{ob}}) \, \rangle \, = \, \langle \, \mathbb{N}^{\ast n} \, \rangle \, = \, \mathbb{Z}^{\ast n} \, = \, \mathrm{Ob}(\hat{X}) \end{eq*}
