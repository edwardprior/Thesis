...
\begin{eq*} F_{\mathrm{s}} : \mathrm{sk}(X) \to \mathrm{sk}(Y), \quad \quad F_{\mathrm{p}} : \mathrm{po}(X) \to \mathrm{po}(Y) \end{eq*}
that make the following diagrams commute:
\begin{eq*} \begin{tikzcd}
X \ar[r, "F"] \ar[d, "R^X"'] & Y \ar[d, "R^Y"] & & X \ar[r, "F"] \ar[d, "P^X"'] & Y \ar[d, "P^Y"] \\
\mathrm{sk}(X) \ar[r, "F_{\mathrm{s}}"] \ar[d, "\lbrack \, \_ \, \rbrack"'] & \mathrm{sk}(Y) \ar[d, "\lbrack \, \_ \, \rbrack"] & & \mathrm{po}(X) \ar[r, "F_{\mathrm{p}}"] \ar[d, "\lbrack \, \_ \, \rbrack"'] & \mathrm{po}(Y) \ar[d, "\lbrack \, \_ \, \rbrack"] \\
...
\begin{eq*} \begin{array}{rcccl}
		F_{\mathrm{p}} & : &  \mathrm{po}(X) & \to & \mathrm{po}(Y) \\
		& : & x & \mapsto & F(x) \\
...
\begin{eq*} \begin{array}{rllrrlll}
		...
		& = & F_{\mathrm{p}}(x) & & & = & F(x) \to F(x') \\
		& = & F_{\mathrm{p}} P^X(x) & & & = & F_{\mathrm{p}}(x \to x') \\
		& & & & & = & F_{\mathrm{p}} P^X(f: x \to x') \\
		& & & & & & \\
		\left[ \, F_{\mathrm{p}}(x) \, \right] & = & [ \, F(x) \, ] & & [ \, F_{\mathrm{p}}(x \to x') \, ] & = & [ \, F(x) \to F(x') \, ] \\
...
\begin{eq*} \begin{tikzcd}
X(r, r) \ar[rr, "F"] \ar[d, "(\rho^X_r)^{-1} \, \circ \, \_ \, \circ \, \rho^X_r"', "\rotatebox{90}{\(\sim\)}"] & & Y\big( F(r), F(r) \big) \ar[d, "(\rho^Y_{F(r)})^{-1} \, \circ \, \_ \, \circ \, \rho^Y_{F(r)}",  "\rotatebox{90}{\(\sim\)}"'] \\
X(r, r) \ar[rr, "F_{\mathrm{s}}"] \ar[d] & & Y\big( RF(r), RF(r) \big) \ar[d] \\
1 \ar[rr, equal] & & 1
\end{tikzcd} \end{eq*}
...
\begin{eq*} F_{\mathrm{s}}(f) \, = \, (\rho^Y_{F(r)})^{-1} \circ F(\rho^X_r) \circ F(f) \circ F(\rho^X_r)^{-1} \circ \rho^Y_{F(r)}  \end{eq*}
...
X\big( R(x), R(x) \big) \ar[rr, "F_{\mathrm{s}}"] & & Y\big( RF(x), RF(x) \big)
\end{tikzcd} \end{eq*}
...
\begin{eq*} \begin{array}{rll}
		F_{\mathrm{s}}(f) & = & (\rho^Y_{F(r)})^{-1} \circ F(\rho^X_r) \circ F(f) \circ F(\rho^X_r)^{-1} \circ \rho^Y_{F(r)}  \\
