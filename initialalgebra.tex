...
\begin{defn} We will also use $s$ and $t$ to denote the homomorphisms $s: \mathrm{Mor}(\mathbb{G}_n) \to \mathrm{Ob}(\mathbb{G}_n)$ and $t: \mathrm{Mor}(\mathbb{G}_n) \to \mathrm{Ob}(\mathbb{G}_n)$ sending morphisms of $\mathbb{G}_n$ to their source and target, respectively.
\end{defn}
...
\begin{eq*} (s \times t)(\mathbb{G}_n) \, = \, \mathbb{N}^{\ast n} \times_{\mathbb{N}^n} \mathbb{N}^{\ast n} \end{eq*}
where this pullback is taken over the quotients of abelianisation for $(\mathbb{N}^{\ast n})^{\mathrm{ab}} = \mathbb{N}^n$,
\begin{eq*} \begin{tikzcd}
\mathbb{N}^{\ast n} \times_{\mathbb{N}^n} \mathbb{N}^{\ast n} \ar[dd] \ar[rr] & & \mathbb{N}^{\ast n} \ar[dd, "\mathrm{ab}"] \\
& & \\
\mathbb{N}^{\ast n} \ar[rr, "\mathrm{ab}"] & & \mathbb{N}^n
\end{tikzcd} \end{eq*}
\end{lem}
\begin{proof}
...
\begin{eq*} \exists \, f \, : \quad s(f) \, = \, w, \quad t(f) \, = \, w' \quad \quad \iff \quad \quad (w, w') \, \in \, \mathbb{N}^{\ast n} \times_{\mathbb{N}^n} \mathbb{N}^{\ast n} \end{eq*}
...
\begin{eq*} \mathrm{Mor}(L\mathbb{G}_n) \, = \, \quotient{\mathrm{Mor}(L\mathbb{G}_n)^{\mathrm{gp, ab}}}{\mathbb{Z}^n} \times \mathbb{Z}^{\ast n} \times_{\mathbb{Z}^n} \mathbb{Z}^{\ast n} \end{eq*}
\end{prop}
\begin{proof}
