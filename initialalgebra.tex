...
To that end, recall from \cref{Gnmapsaction} that every morphism in $\mathbb{G}_n$ can be expressed in a canonical way as an action morphism. Since maps between $\mathrm{E}G$-algebras preserve the action, this means that for any surjective algebra map $F: \mathbb{G}_n \to X$, the action on $X$ can always be recovered in full from the underlying monoidal functor of $F$. That is, for any morphisms $f_1, ..., f_m$ of $X$ we can choose some morphisms $f'_1, ..., f'_m$ of $\mathbb{G}_n$ with $F(f'_i) = f_i$, and then for each $g \in G(m)$ we'll have
...
\begin{prop}
\begin{eq*} \mathrm{Mor}(PL\mathbb{G}_n) \, = \, L\mathbb{G}_n(I, I) \times \mathrm{Ob}(L\mathbb{G}_n) \end{eq*}
\end{prop}

\begin{cor}
\begin{eq*} L\mathbb{G}_n(I, I) \, = \, \quotient{\mathrm{Mor}(PL\mathbb{G}_n)^{\mathrm{gp, ab}}}{\mathrm{Ob}(L\mathbb{G}_n)^{\mathrm{gp, ab}}} \end{eq*}
\end{cor}

\begin{prop}
\begin{eq*} \quotient{\mathrm{Mor}(P\mathbb{G}_n)^{\mathrm{gp, ab}}}{\mathrm{Ob}(\mathbb{G}_n)^{\mathrm{gp, ab}}} \, = \, \quotient{\mathrm{Mor}(PL\mathbb{G}_n)^{\mathrm{gp, ab}}}{\mathrm{Ob}(L\mathbb{G}_n)^{\mathrm{gp, ab}}} \end{eq*}
\end{prop}
...
\begin{prop} The monoid of morphisms of the algebra $\mathbb{G}_n$ is
...
\begin{eq*} \begin{tikzcd}
G \times_{\mathbb{N}} F\big( \, \{z_1, ..., z_n\} \, \big) \ar[dd] \ar[rr] & & F\big( \, \{z_1, ..., z_n\} \, \big) \ar[dd, "| \, \_ \, |"] \\
& & \\
G \ar[rr, "| \, \_ \, |"] & & \mathbb{N} \\
\end{tikzcd} \end{eq*}
...
\begin{prop} Full description of $L\mathbb{G}_n(I, I)$ and $\mathrm{Mor}(PL\mathbb{G}_n)$
\end{prop}
...
\begin{prop}
\begin{eq*} \mathrm{Mor}(T\mathbb{G}_n) \, \cong \, \mathbb{N}^{\ast n} \times_{\mathbb{N}^n} \mathbb{N}^{\ast n} \end{eq*}
\end{prop}
...
\begin{prop}
\begin{eq*} \mathrm{Mor}(L\mathbb{G}_n) \, = \, L\mathbb{G}_n(I, I) \times \mathrm{Mor}(TL\mathbb{G}_n) \end{eq*}
\end{prop}

\begin{cor}\label{Zmor}
\begin{eq*} \mathrm{Mor}(L\mathbb{G}_n) \, = \, ??? \times \mathbb{Z}^{\ast n} \times_{\mathbb{Z}^n} \mathbb{Z}^{\ast n}\end{eq*}
\end{cor}