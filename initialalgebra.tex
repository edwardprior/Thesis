...
\begin{eq*} \begin{array}{lrll}
		...
		& x & \mapsto & I \\
		& f & \mapsto & f \otimes \mathrm{id}_{x^*}
		\end{array} .
\end{eq*}
...
\begin{eq*}\begin{array}{c}
		...
		= \\
		\Big( \, \big( \, \rho_{x' \otimes y'}^{-1} \circ ( \rho_{x'} \otimes \rho_{y'} ) \circ ( f \otimes \mathrm{id}_{\mathrm{rep}(x)} \otimes g \otimes \mathrm{id}_{\mathrm{rep}(y)} ) \circ ( \rho_{x}^{-1} \otimes \rho_{y}^{-1} ) \circ \rho_{x \otimes y} \, \big) \otimes \mathrm{id}_{\mathrm{rep}(x \otimes y)^*} \, , \\
...
\begin{eq*} \begin{array}{rll}
		...
		& = & F'\alpha( \, e \, ; \, \rho_{x'} ( f \otimes \mathrm{id}_{\mathrm{rep}(x)} ) \rho_{x}^{-1}, \, \rho_{y'} ( g \otimes \mathrm{id}_{\mathrm{rep}(y)} ) \rho_{y}^{-1} \, ) \\
		& = & F'\Big( \, \big( \, \rho_{x'} ( f \otimes \mathrm{id}_{\mathrm{rep}(x)} ) \rho_{x}^{-1} \, \big) \otimes \big( \, \rho_{y'} ( g \otimes \mathrm{id}_{\mathrm{rep}(y)} ) \rho_{y}^{-1} \, \big) \, \Big) \\
		& = & F'\big( \, ( \rho_{x'} \otimes \rho_{y'} ) \circ ( f \otimes \mathrm{id}_{\mathrm{rep}(x)} \otimes g \otimes \mathrm{id}_{\mathrm{rep}(y)} ) \circ ( \rho_{x}^{-1} \otimes \rho_{y}^{-1} ) \, \big) \\
		& = & \Big( \, \big( \, \rho_{x' \otimes y'}^{-1} \circ ( \rho_{x'} \otimes \rho_{y'} ) \circ ( f \otimes \mathrm{id}_{\mathrm{rep}(x)} \otimes g \otimes \mathrm{id}_{\mathrm{rep}(y)} ) \circ ( \rho_{x}^{-1} \otimes \rho_{y}^{-1} ) \circ \rho_{x \otimes y} \, \big) \otimes \mathrm{id}_{\mathrm{rep}(x \otimes y)^*} \, , \\
		&& \quad x \otimes y \to x' \otimes y' \Big).		
		\end{array}
\end{eq*}
...
\begin{eq*} \begin{array}{rllll}
		\_ \otimes \mathrm{id}_v & : & \mathbb{G}_n(w, w) & \to & \mathbb{G}_n( w \otimes v, w \otimes v) \\
		\mathrm{id}_v \otimes \_ & : & \mathbb{G}_n(w, w) & \to & \mathbb{G}_n( v \otimes w, v \otimes w)
		\end{array}
\end{eq*}
...
\begin{eq*}	i_{w \otimes v}(f \otimes g) =  i_{x \otimes w \otimes y \otimes v \otimes z}(\mathrm{id}_x \otimes f \otimes \mathrm{id}_y \otimes g \otimes \mathrm{id}_z) .\end{eq*}
But this is indeed the case, since
\begin{eq*}\begin{array}{rll}
		\mathrm{id}_x \otimes f \otimes \mathrm{id}_y \otimes g \otimes \mathrm{id}_z & = &  (\mathrm{id}_x \otimes f \otimes \mathrm{id}_y \otimes \mathrm{id}_v \otimes \mathrm{id}_z) \circ (\mathrm{id}_x \otimes \mathrm{id}_w \otimes \mathrm{id}_y \otimes g \otimes \mathrm{id}_z) \\
...
\begin{eq*} a : \mathrm{Ob}(\mathbb{G}_n) \to \mathrm{Ob}(X), \end{eq*}
\item an injective monoid homorphism
\begin{eq*} b : \pi_0(\mathbb{G}_n) \to \pi_0(X) \end{eq*}
\item an abelian group homomorphism
\begin{eq*} c : \mathrm{colim}(D) \to X(I,I), \end{eq*}
\end{itemize}
which satisfy the following relation:
\begin{eq*} \xymatrix{
\mathrm{Ob}(\mathbb{G}_n) \ar[r]^{[\_]} \ar[d]_{a} & \pi_0(\mathbb{G}_n)  \ar[d]^{b} \\
...
\begin{eq*} \psi_w(f) := \psi(f) \otimes \mathrm{id}_{\psi(w)^*} \implies \psi(f) = \psi_w(f) \otimes \mathrm{id}_{\psi(w)} = \psi_D \circ i_w (f) \otimes \mathrm{id}_{\psi_{\mathrm{ob}}(w)} \end{eq*}
...
\begin{eq*} \xymatrix{
\mathbb{G}_n(w,w) \times \mathbb{G}_n(v,v) \ar[rr]^{\otimes} \ar[d]_{i_w \times i_v} && \mathbb{G}_n( w \otimes v, w \otimes v)  \ar[d]^{i_{w \otimes v}} \\
\mathrm{colim}(D) \times \mathrm{colim}(D) \ar[rr]^{\otimes} \ar[d]_{\psi_D \times \psi_D} && \mathrm{colim}(D) \ar[d]^{\psi_D} \\
X(I,I) \times X(I,I) \ar[rr]^{\otimes} \ar[d]_{(\_ \otimes \mathrm{id}_{\psi(w)}) \times (\_ \otimes \mathrm{id}_{\psi(v)})} && X(I,I) \ar[d]^{\_ \otimes \mathrm{id}_{\psi(w \otimes v)}} \\
X\big( \psi(w), \psi(w) \big) \times X\big( \psi(v), \psi(v) \big) \ar[rr]^{\otimes} && X\big(\psi(w \otimes v), \psi(w \otimes v)\big)  }.
\end{eq*}
...
\begin{eq*}\begin{array}{rll}
		...
		\implies \big( \, \mathrm{id}_{\psi_\pi([w])}, \, \psi^w(f), \, \psi_w(w') \to \psi_w(w'') \, \big) & = & u' \big( \, \mathrm{id}_{\chi_\pi([w])}, \, \chi^w(f), \, \chi_w(w') \to \chi_w(w'') \, \big) \\
		\end{array}. 
\end{eq*}
...
\begin{eq*} \widehat{\phi}\alpha(g; \mathrm{id}_{w_1}, ..., \mathrm{id}_{w_m}) = \alpha(g; \mathrm{id}_{\widehat{\phi}(w_1)}, ..., \mathrm{id}_{\widehat{\phi}(w_m)}) \end{eq*}
